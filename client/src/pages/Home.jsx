        ...
        <div className="max-w-7xl mx-auto grid grid-cols-2 md:grid-cols-6 gap-x-8 gap-y-12 mb-16 text-sm">
          <div className="col-span-2 md:col-span-2">
            <div className="flex items-center gap-2 mb-6">
              <div className="w-8 h-8 bg-blue-600 rounded flex items-center justify-center text-white"><LayoutDashboard size={16} /></div>
              <h1 className="text-2xl font-bold tracking-tight text-white">CareerFlow</h1>
            </div>
            <p className="text-slate-400 mb-6 pr-4 leading-relaxed">Building the intelligent infrastructure for accessible, secure recruiting and career development in the Philippines.</p>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-3">
              <li><Link to="#" className="hover:text-blue-400 transition-colors">Voice Builder</Link></li>
              <li><Link to="#" className="hover:text-blue-400 transition-colors">Job Matching</Link></li>
              <li><Link to="#" className="hover:text-blue-400 transition-colors">HR Dashboard</Link></li>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-3">
              <li><Link to="#" className="hover:text-blue-400 transition-colors">For Job Seekers</Link></li>
              <li><Link to="#" className="hover:text-blue-400 transition-colors">For Employers</Link></li>
              <li><Link to="#" className="hover:text-blue-400 transition-colors">Enterprise HR</Link></li>
            </ul>
          </div>
          ...
          <div className="col-span-2 md:col-span-2">
            ...
            <form className="flex gap-2">
              <input type="email" placeholder="Email address" className="w-full px-4 py-3 bg-slate-800 border border-slate-700 rounded-lg focus:outline-none focus:border-blue-500 text-white text-sm" />
              <button className="px-6 py-3 bg-blue-600 text-white font-bold rounded-lg hover:bg-blue-500 transition-colors whitespace-nowrap">Subscribe</button>
            </form>
          </div>
        </div>

        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center pt-8 border-t border-slate-800 text-xs text-slate-500">
